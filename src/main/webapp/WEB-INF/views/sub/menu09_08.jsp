					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<li class="item">
									<a href="${pageContext.request.contextPath}/menu09_08read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}" style="background-image: url('${pageContext.request.contextPath}/resources/uploadCaution/${item.thumb_stored}');"><b>${item.title}</b></a>
								</li>
							</c:forEach>
					    </c:otherwise> 
					</c:choose>
