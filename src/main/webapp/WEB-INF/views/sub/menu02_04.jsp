...
$(function(){
	...
	$("#header > #gnb > .inner > ul > li:nth-child(2) > .lnb-wrap > li:nth-child(4)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="가격안내">
			...
			<div class="sub-contents">
				<div class="inner pt50 pb50">
					<img src="${pageContext.request.contextPath}/resources/img/main/price01.jpg">
					<img src="${pageContext.request.contextPath}/resources/img/main/price02.jpg">
					<img src="${pageContext.request.contextPath}/resources/img/main/price03.jpg">
				</div>
			</div>
