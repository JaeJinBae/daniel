...
$(function(){
	...
	$("#header > #gnb > .inner > ul > li:nth-child(7) > .lnb-wrap > li:nth-child(1)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="하모니 지방흡입">
			...
			<div class="sub-contents pcode52501">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/525_img_01.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52502">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/525_img_02.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52503">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/525_img_03.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52504">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/525_img_04.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52505">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/525_img_05.png" alt="">
				</div>
			</div>
				...
				<div class="caoution-info"><img src="${pageContext.request.contextPath}/resources/img/contents/icon_caoution.png" alt="">위 주의사항은 꼭 지켜주시고 <em>이상증상이 있을 시 연락</em>주세요.</div>
					...
					<div class="double-banner">
						<ul>
							...
							<li>
								<a href="${pageContext.request.contextPath}/menu05_01"><img src="${pageContext.request.contextPath}/resources/img/contents/double_banner03.png" alt="다니엘 레이저"></a>
							</li>
						</ul>
					</div>
