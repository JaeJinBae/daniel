...
<script>
$(function(){
	$("#header > #gnb > .inner > ul > li:nth-child(2)").addClass("active");
	$("#header > #gnb > .inner > ul > li:nth-child(2) > .lnb-wrap > li:nth-child(2)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="안면윤곽주사">
			...
			<div class="sub-contents pcode52201">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/522_img_01.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode52202">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/522_img_02.png" alt="">
				</div>
			</div>
			...
			<div class="sub-contents pcode52204">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/522_img_04.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode52205">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/522_img_05.png" alt="">
				</div>
			</div>
