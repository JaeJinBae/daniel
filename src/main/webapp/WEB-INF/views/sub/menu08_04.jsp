...
$(function(){
	...
	$("#header > #gnb > .inner > ul > li:nth-child(8) > .lnb-wrap > li:nth-child(4)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="스킨부스터">
			...
			<div class="sub-contents pcode70901">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/709_img_01.png" alt="">
				</div>
			</div>
