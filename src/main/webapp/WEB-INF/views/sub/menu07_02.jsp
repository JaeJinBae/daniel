...
$(function(){
	...
	$("#header > #gnb > .inner > ul > li:nth-child(7) > .lnb-wrap > li:nth-child(2)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="아큐주사">
			...
			<div class="sub-contents pcode52601">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/526_img_01.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52602">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/526_img_02.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52603">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/526_img_03.png" alt="">
				</div>
			</div>
			<div class="sub-contents pcode52604">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/526_img_04.png" alt="">
				</div>
			</div>
