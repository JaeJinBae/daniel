...
$(function(){
	...
	$("#header > #gnb > .inner > ul > li:nth-child(8) > .lnb-wrap > li:nth-child(2)").addClass("active");
});
</script>
</head>
<body>
	...
	<div id="wrap">
		...
		<section id="sub-container">
			...
			<!-- 서브 비주얼영역 시작  -->
			<div id="sub-visual" data-menu="두피탈모">
			...
			<div class="sub-contents pcode51601">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_01.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51602">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_02.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51603">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_03.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51604">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_04.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51605">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_05.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51606">
				<div class="inner">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_06.png" alt="">
				</div>
			</div>
			
			<div class="sub-contents pcode51607">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/contents/516_img_07.png" alt="">
				</div>
			</div>
