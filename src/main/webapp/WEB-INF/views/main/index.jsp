				...
				<ul class="slider-banner">
					...
					<li class="item" style="background:url(${pageContext.request.contextPath}/resources/img/main/thumb08.png) no-repeat center top;">
						<div class="slider-banner-info">
							...
							<a href="${pageContext.request.contextPath}/menu09_06read?page=1&perPageNum=12&searchType&keyword&no=33" class="more" title="자세히 보기" data-slick-inner="5">자세히</a>
						</div>
					</li>
					<li class="item" style="background:url(${pageContext.request.contextPath}/resources/img/main/thumb06.jpg) no-repeat center top;">
						<div class="slider-banner-info">
							...
							<a href="${pageContext.request.contextPath}/menu09_06read?page=1&perPageNum=12&searchType&keyword&no=31" class="more" title="자세히 보기" data-slick-inner="5">자세히</a>
						</div>
					</li>	
					...
					<li class="item" style="background:url(${pageContext.request.contextPath}/resources/uploadEvent/1571388802207_thumb36.jpg) no-repeat center top;">
						<div class="slider-banner-info">
							...
							<a href="${pageContext.request.contextPath}/menu09_06read?page=1&perPageNum=12&searchType&keyword&no=36" class="more" title="자세히 보기" data-slick-inner="5">자세히</a>
						</div>
					</li>
				</ul><!-- 슬라이드 배너 끝 -->
			</section>
