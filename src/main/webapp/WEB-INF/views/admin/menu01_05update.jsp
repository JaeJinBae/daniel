...
$(function(){
	...
	$("#delBtn").click(function(){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/admin/menu01_05delete/"+no,
			type:"get",
			dataType:"text",
			async:false,
			success:function(json){
				location.href="${pageContext.request.contextPath}/admin/menu01_05";
			} 
		});
	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form name="board" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu01_05update${pageMaker.makeSearch(pageMaker.cri.page)}">
					...
					<div class="write_area">
						<div class="write_box">
							<table class="write_table">
								...
								<tr class="cont">
									...
									<td>
										<input type="text" class="w_form_s" name="regdate" value="${item.regdate}" readonly="">
									</td>
								</tr>
								<tr class="cont">
						...
						<div class="btn_area">
							<p class="btn_left">
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu01_05'">리스트</button>
							</p>
							<p class="btn_right">
								<input type="submit" class="btn_black" value="수정">&nbsp;
								<button type="button" class="btn_red" id="delBtn">삭제</button>
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu01_05'">취소</button>
							</p>
						</div>
					</div>
				</form>
