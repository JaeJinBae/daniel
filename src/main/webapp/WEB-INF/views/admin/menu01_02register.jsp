		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<div class="write_area">
						...
						<form name="board" id="board" method="post" enctype="multipart/form-data" action="board_proc.php">
							...
							<table class="write_table" cellpadding="0">
								...
								<tr class="cont">
									...
									<td>
										<select name="b_tap" id="b_tap" class="search_sel">
								...
								<tr class="cont">
									...
									<td id="attach"><div><input type="file" name="upload[0]"></div><div class="marginT10"><input type="file" name="upload[1]"></div><br><strong></strong></td>
								</tr>
					...
					<div class="btn_area">
						<p class="btn_left">
							<button type="button" class="btn_gray" onclick="board_it('list', 'select_key=&amp;input_key=&amp;search=&amp;Scod=BRD20&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;page=1&amp;radio_key=')">리스트</button>
						</p>
			
						<p class="btn_right">
			
							<button type="button" class="btn_black" onclick="board_it('submit')">등록</button>
							<button type="button" class="btn_gray" onclick="board_it('reset', 'select_key=&amp;input_key=&amp;search=&amp;Scod=BRD20&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;page=1&amp;radio_key=')">취소</button>
						</p>
					</div>
			...
			<script type="text/javascript">
				$(function(){
					...
					if( ($Scmt == "Y") && ($mode == "modify") )	vboard_it('comment', 'Scod=BRD20&b_seq=');
