	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form name="board" id="board" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu01_05register">
					<div class="write_area">
						...
						<div class="btn_area">
							...
							<p class="btn_right">
								...
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu01_05register'">취소</button>
							</p>
						</div>
					</div><!-- write_area end -->
				</form>
