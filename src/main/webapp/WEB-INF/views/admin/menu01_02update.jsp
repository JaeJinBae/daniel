		...
		<div id="admin_right">
				...
				<div class="write_area">
					<div class="write_box">
						...
						<form name="board" id="board" method="post" enctype="multipart/form-data" action="board_proc.php">
							...
							<input type="hidden" name="seq" value="2104">
							...
							<input type="hidden" name="Sfle" value="2">
							...
							<table class="write_table" cellpadding="0">
								...
								<tr class="cont">
									...
									<td>
										<select name="b_tap" id="b_tap" class="search_sel"><option value="동안·탄력 클리닉">동안·탄력 클리닉</option><option value="레이저클리닉">레이저클리닉</option><option value="흉터클리닉">흉터클리닉</option><option value="눈·코 성형" selected="">눈·코 성형</option><option value="프리미엄 쁘띠클리닉">프리미엄 쁘띠클리닉</option><option value="체형클리닉">체형클리닉</option><option value="두피클리닉">두피클리닉</option></select>
									</td>
								</tr>
								...
								<tr class="cont">
									...
									<td>
										<input type="text" class="w_form_s" name="b_readcnt" value="0" valid="none,number" element-name="조회수">
									</td>
								</tr>
								...
								<tr class="cont">
									...
									<td>
										<input type="text" class="w_form_l" name="b_title" value="하안검 절개" onkeypress="fnChkRemark(this, '120')" onkeyup="fnChkRemark(this, '120')" valid="required" element-name="제목">
									</td>
								</tr>
								<tr class="cont">
								...
								<tr class="cont">
									...
									<td id="attach">
										<div id="file_1189">
											<a href="javascript:;" onclick="board_it('download', '1189')">성미자_전.png</a>
											<img src="${pageContext.request.contextPath}/resources/img/admin/icon_image_edit.png" class="cursor vimg" onclick="">
											<img src="${pageContext.request.contextPath}/resources/img/admin/icon_x.png" class="vimg cursor" onclick="">
										</div>
										<div id="file_1190" class="marginT10">
											<a href="javascript:;" onclick="board_it('download', '1190')">성미자_후.png</a>
											<img src="${pageContext.request.contextPath}/resources/img/admin/icon_image_edit.png" class="cursor vimg" onclick="">
											<img src="${pageContext.request.contextPath}/resources/img/admin/icon_x.png" class="vimg cursor" onclick="">
										</div>
										<br><strong></strong>
					...
					<div class="btn_area">
						...
						<p class="btn_right">
							<button type="button" class="btn_gray" onclick="">답변</button>&nbsp;
			...
			<script type="text/javascript">
				$(function(){
					...
					if( ($Scmt == "Y") && ($mode == "modify") )	vboard_it('comment', 'Scod=BRD20&b_seq=2104');
