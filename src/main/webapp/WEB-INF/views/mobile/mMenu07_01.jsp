...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="체형 클리닉" data-menu="하모니 지방흡입">
				<div class="inner">
			...
			<div class="sub-contents pCode-525-01">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_01.png" alt="성형외과 &amp; 피부과 협진으로 최소 시술 최대 효과" usemap="pCode-525-01">
				</div>
			</div>
			<div class="sub-contents pCode-525-02">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_02.png" alt="프리미엄 오리지널 명품 레이저 보유" usemap="pCode-525-02">
				</div>
			</div>
			<div class="sub-contents pCode-525-03">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_03.png" alt="오랜 임상 경험과 노하우를 통해 완성된 최적화 프로그램" usemap="pCode-525-03">
				</div>
			</div>
			<div class="sub-contents pCode-525-04">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_04.png" alt="주치의 &amp; 전담 관리사 &amp; 담당매니저의 집중 관리" usemap="pCode-525-04">
				</div>
			</div>
			<div class="sub-contents pCode-525-05">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_05.png" alt="" usemap="pCode-525-05">
				</div>
			</div>
			<div class="sub-contents pCode-525-06">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/525_img_06.png" alt="" usemap="pCode-525-06">
				</div>
			</div>
			...
			<map name="pCode-499-02">
			  <area shape="rect" coords="118,540,260,574" href="#">
			  <area shape="rect" coords="393,540,534,575" href="#">
			  <area shape="rect" coords="118,846,258,880" href="#">
			  <area shape="rect" coords="392,846,533,880" href="#">
			  <area shape="rect" coords="279,966,363,1050" href="#">
			</map>
			<!-- 프리미엄 오리지널 명품 레이저 보유 맵 끝 -->
			
			<!-- 최적화 프로그램 맵 시작 -->
			<map name="pCode-499-03">
			  <area shape="rect" coords="91,468,128,505" href="#">
			  <area shape="rect" coords="301,468,340,504" href="#">
			  <area shape="rect" coords="511,467,547,505" href="#">
			  <area shape="rect" coords="146,718,185,754" href="#">
			  <area shape="rect" coords="457,718,493,754" href="#">
			</map>
			<!-- 최적화 프로그램 맵 끝 -->
			...
			<div id="caoution">
				<div class="inner">
					...
					<div class="caoution-list">
						<span><em>지방흡입</em>주의사항</span>
						<ol>
							<li>수술부위약물이 새어 나올 수 있으니 수건을 깔고 주무세요.</li>
							<li>처방약은 꼭 복용하여주세요.</li>
						
						
							
							<li>수술 후 3주간 금주,금연하여 주세요.</li>
							<li>수술 후 3주간 목욕,사우나,수영장,운동은 삼가주세요.</li>
							<li>3일 뒤 방수테이프 사용 후 샤워가능합니다.</li>
							<li>보정속옷 한달 이상 착용해주세요. <br>(사이즈 감소 시 재수선 후 3개월 이상 착용)</li>
