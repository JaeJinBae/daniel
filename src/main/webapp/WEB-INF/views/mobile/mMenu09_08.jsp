		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div class="board-kinds">
				...
				<ul class="inner">
					...
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">동안·탄력 클리닉<input type="hidden" value="동안·탄력 클리닉"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">레이저클리닉<input type="hidden" value="레이저클리닉"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">흉터클리닉<input type="hidden" value="흉터클리닉"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">눈·코 성형<input type="hidden" value="눈·코 성형"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">프리미엄 쁘띠클리닉<input type="hidden" value="프리미엄 쁘띠클리닉"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">체형클리닉<input type="hidden" value="체형클리닉"></a></li>
					<li><a href="${pageContext.request.contextPath}/m/menu09_08?page=1&amp;perPageNum=12&amp;searchType=ct&amp;keyword=">두피클리닉<input type="hidden" value="두피클리닉"></a></li>
				</ul>
			</div>
					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<li class="item">
									<a href="${pageContext.request.contextPath}/m/menu09_08read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}" style="background-image: url('${pageContext.request.contextPath}/resources/uploadCaution/${item.thumb_stored}');"><b>${item.title}</b></a>
								</li>
							</c:forEach>
					    </c:otherwise> 
					</c:choose>
