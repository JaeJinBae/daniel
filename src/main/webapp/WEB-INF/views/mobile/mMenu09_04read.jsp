...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="커뮤니티" data-menu="리얼스토리">
				<div class="inner">
				...
				<ul class="full">
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/m/menu09_04read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/m/menu09_04read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
				</ul>
			...
			<div class="btn-group">
				<div class="inner">
					<a href="${pageContext.request.contextPath}/m/menu09_04" class="btn btn-list">목록으로</a>
				</div>
			</div>
			<!-- 게시판 버튼 끝 -->
