...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="커뮤니티" data-menu="공지사항">
				<div class="inner">
			...
			<div class="board-notice-list">
				<ul class="full">
					<li>
						<a href="?pCode=527&amp;mode=view&amp;perm=Y&amp;pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=1&amp;seq=2075">
							<b>  다니엘 성형외과 5월 워크샵 휴진 안내</b>
							<!--i class='name'>다</i><span class='line'>|</span--><i class="date">2019-05-07</i>
						</a>	
					</li>
				
					<li>
						<a href="?pCode=527&amp;mode=view&amp;perm=Y&amp;pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=1&amp;seq=2036">
							<b>  다니엘 성형외과 화요일 진료시간변경안내</b>
							<!--i class='name'>다</i><span class='line'>|</span--><i class="date">2019-02-15</i>
						</a>	
					</li>
			...
			<div id="board-pagenation">
				<div class="inner">
					...
					<a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=2 ">2</a>
					<a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=3 ">3</a>
					<a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=4 ">4</a>
					<a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=5 ">5</a>
					<a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=6 "><svg class="svg-inline--fa fa-angle-right fa-w-8" aria-hidden="true" data-fa-processed="" data-prefix="fas" data-icon="angle-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512"><path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z"></path></svg><!-- <i class="fas fa-angle-right"></i> --></a><a href="?pCode=527&amp;select_key=&amp;input_key=&amp;backpage=/m/527/&amp;Scod=BRD01&amp;delflag=Y&amp;sort=b_notice ASC, b_ref DESC, b_step ASC, seq DESC&amp;btap=&amp;page=17 "><svg class="svg-inline--fa fa-angle-double-right fa-w-14" aria-hidden="true" data-fa-processed="" data-prefix="fas" data-icon="angle-double-right" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34zm192-34l-136-136c-9.4-9.4-24.6-9.4-33.9 0l-22.6 22.6c-9.4 9.4-9.4 24.6 0 33.9l96.4 96.4-96.4 96.4c-9.4 9.4-9.4 24.6 0 33.9l22.6 22.6c9.4 9.4 24.6 9.4 33.9 0l136-136c9.4-9.2 9.4-24.4 0-33.8z"></path></svg></a>
				</div>
			</div><!-- 페이징 끝 -->
