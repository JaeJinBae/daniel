	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div class="board-notice-view">
				<ul class="full">
					<li class="subject">	
						<div class="title"> 안면거상/이마내시경거상술</div>
						<p class="info">
							<i class="date">2018-10-10</i><span class="line">|</span><i class="hit">조회수		168</i>
						</p>
					</li>
					<li class="con">
						<div id="caoution">
							<div class="inner">
								<div class="caoution-title">다니엘성형외과
								<p>시술&amp;수술 후 <em>주의사항</em></p>
								</div>
								<!-- 주의사항 리스트 시작 -->
								
								<div class="caoution-list"><span><em>안면거상술<br>이마거상술</em>주의사항</span>
								...
								<div class="caoution-info"><img alt="" src="${pageContext.request.contextPath}/resources/img/contents/icon_caoution.png">위 주의사항은 꼭 지켜주시고 <em>이상증상이 있을 시 연락</em>주세요.</div>
							
								<div class="double-banner">
									<ul>
										<li><a href="/html/?pCode=563"><img alt="다니엘 성형외과 이벤트" src="${pageContext.request.contextPath}/resources/img/contents/double_banner01.png"></a></li>
										<li><a href="/html/?pCode=521"><img alt="다니엘 쁘띠클리닉" src="${pageContext.request.contextPath}/resources/img/contents/double_banner02.png"></a></li>
									</ul>
								</div>
							</div>
						</div>		
			...
			<div class="prev-next-list">
				<ul class="full">
					<li>
						<span>이전글</span><a href=""><b>[동안·탄력 클리닉]</b> 리프팅레이저</a>		</li>
					<li>
						<span>다음글</span><a href=""><b>[동안·탄력 클리닉]</b> 실리프팅</a>		</li>
				</ul>
			</div>
