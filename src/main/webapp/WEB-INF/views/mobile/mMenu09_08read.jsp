...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
				...
				<ul class="full">
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/m/menu09_08read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${beforeItem.no}">${beforeItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
					<li>
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="${pageContext.request.contextPath}/m/menu09_08read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${afterItem.no}">${afterItem.title}</a>
							</c:otherwise>
						</c:choose>
					</li>
				</ul>
			...
			<div class="btn-group">
				<div class="inner">
					<a href="${pageContext.request.contextPath}/m/menu09_08" class="btn btn-list">목록으로</a>
				</div>
			</div>
			<!-- 게시판 버튼 끝 -->
