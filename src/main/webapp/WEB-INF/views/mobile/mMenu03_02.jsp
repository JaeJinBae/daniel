			...
			<div id="caoution">
				<div class="inner">
					...
					<div class="double-banner">
						<ul>
							<li>
								<a href="/m/564/?pCode=564"><img src="${pageContext.request.contextPath}/resources/img/contents/double_banner01.png" alt="다니엘 성형외과 이벤트"></a>
							</li>
							<li>
								<a href="/m/517/?pCode=517"><img src="${pageContext.request.contextPath}/resources/img/contents/double_banner05.png" alt="다니엘 눈코성형"></a>
							</li>
						</ul>
					</div>
