...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="다니엘 소개" data-menu="선한이웃, 다니엘">
				<div class="inner">
			...
			<div class="sub-contents">
				<div class="inner" style="margin:0 auto;">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_01.jpg" alt="">
					<div class="pcode708-movie">
						<div class="movie">
						...
						<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_02.jpg" alt="">
					</div>
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_03.jpg" alt="">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_04.jpg" alt="">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_05.jpg" alt="">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_06.jpg" alt="">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/708_img_07.jpg" alt="">
				</div>
			</div>
