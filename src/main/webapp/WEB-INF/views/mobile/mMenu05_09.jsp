			...
			<div id="caoution">
				<div class="inner">
					...
					<div class="double-banner">
						<ul>
							<li><a href="/m/?pCode=564"><img src="${pageContext.request.contextPath}/resources/img/contents/double_banner01.png" alt="다니엘 성형외과 이벤트"></a></li>
							<li><a href="/m/?pCode=521"><img src="${pageContext.request.contextPath}/resources/img/contents/double_banner02.png" alt="다니엘 쁘띠클리닉"></a></li>
						</ul>
					</div>
