		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
				...
				<ul class="full">
					...
					<form name="inquire" id="inquire" method="post" action="" enctype="multipart/form-data" onsubmit="return false">
						...
						<li class="board-counsel-content">
							...
							3.보통 맞으면 지속기간이 얼마나 가나요?  4. 결제방식은 신용카드도 가능하나요?
						</li>
					<!-- // 게시글 상세 내용 -->
					</form>
				</ul>
			...
			<div class="btn-group">
				<div class="inner">
					<ul>
						<li class="fl">
							<a href="/m/528/?pCode=528&amp;action=&amp;psseq=&amp;pagecode=&amp;select_key=&amp;input_key=&amp;nextmode=&amp;backpage=/m/528/&amp;i_cate=CN01&amp;kind=&amp;m_id=&amp;delflag=1&amp;page=1" class="btn btn-view-list">목록으로</a>
						</li>
						<li class="fr">
							<a href="javascript:inquire_it('delete', 'pCode=528&amp;action=&amp;psseq=&amp;pagecode=&amp;mode=delete&amp;distinction=proc&amp;perm=Y&amp;select_key=&amp;input_key=&amp;nextmode=&amp;backpage=/m/528/&amp;i_cate=CN01&amp;kind=&amp;m_id=&amp;delflag=1&amp;page=1&amp;seq=2474')" class="btn btn-del">삭제</a>&nbsp;<a href="?pCode=528&amp;action=&amp;psseq=&amp;pagecode=&amp;mode=modify&amp;distinction=modify&amp;perm=Y&amp;select_key=&amp;input_key=&amp;nextmode=&amp;backpage=/m/528/&amp;i_cate=CN01&amp;kind=&amp;m_id=&amp;delflag=1&amp;page=1&amp;seq=2474" class="btn btn-update">수정</a>&nbsp;
						</li>
					</ul>		
				</div>
			</div>
