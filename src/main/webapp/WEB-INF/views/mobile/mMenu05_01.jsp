...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="리프팅 클리닉" data-menu="써마지FLX">
				<div class="inner">
			...
			<div class="sub-contents pCode-706-01">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/706_img_01.png" alt="성형외과 &amp; 피부과 협진으로 최소 시술 최대 효과" usemap="pCode-706-01">
				</div>
			</div>
			<div class="sub-contents pCode-706-02">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/706_img_02.png" alt="프리미엄 오리지널 명품 레이저 보유" usemap="pCode-706-02">
				</div>
			</div>
			<div class="sub-contents pCode-706-03">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/706_img_03.png" alt="오랜 임상 경험과 노하우를 통해 완성된 최적화 프로그램" usemap="pCode-706-03">
				</div>
			</div>
			<div class="sub-contents pCode-706-04">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/706_img_04.png" alt="주치의 &amp; 전담 관리사 &amp; 담당매니저의 집중 관리" usemap="pCode-706-04">
				</div>
			</div>
			<div class="sub-contents pCode-706-05">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/706_img_05.png" alt="" usemap="pCode-706-05">
				</div>
			</div>			
