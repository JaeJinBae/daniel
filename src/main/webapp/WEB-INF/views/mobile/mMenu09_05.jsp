		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div class="board-notice-list">
				<ul class="full">
					<li>
						<a href="">
							<b>  [자필후기] 여드름과 여드름흉터, 주근깨 치료 후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-07-15</i>
						</a>	
					</li>
				
					<li>
						<a href="p">
							<b>  [자필후기] 눈밑기미와 피부 흉터치료 후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-07-15</i>
						</a>	
					</li>
					...
					<li>
						<a href="">
							<b>  [자필후기] 색소(잡티) 치료 후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-06-11</i>
						</a>	
					</li>
				
					<li>
						<a href="">
							<b>  [자필후기] 동안/탄력 레이저 시술 후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-06-11</i>
						</a>	
					</li>
					...
					<li>
						<a href="">
							<b>  [자필후기] 코필러 시술 후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-04-03</i>
						</a>	
					</li>
					...
					<li>
						<a href="">
							<b>  [자필후기] 악성기미 치료후기입니다.</b>
							<!--i class='name'>t</i><span class='line'>|</span--><i class="date">2019-03-08</i>
						</a>	
					</li>
				</ul>
			</div>
