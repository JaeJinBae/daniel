					...
					<c:choose>
					    ...
					    <c:otherwise>
					        <c:forEach var="item" items="${list}">
								<li>
									<a href="${pageContext.request.contextPath}/m/menu09_05read${pageMaker.makeSearch(pageMaker.cri.page)}&no=${item.no}">
										<b>  ${item.title}</b>
										<!--i class='name'>t</i><span class='line'>|</span--><i class="date">${item.regdate}</i>
									</a>	
								</li>
							</c:forEach>
					    </c:otherwise> 
