...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
			...
			<div id="sub-visual" data-sec="레이저 클리닉" data-menu="프리미엄 토닝">
				<div class="inner">
			...
			<div class="sub-contents pCode-689-01">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_01.png" alt="성형외과 &amp; 피부과 협진으로 최소 시술 최대 효과" usemap="pCode-689-01">
				</div>
			</div>
			<div class="sub-contents pCode-689-02">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_02.png" alt="프리미엄 오리지널 명품 레이저 보유" usemap="pCode-689-02">
				</div>
			</div>
			<div class="sub-contents pCode-689-03">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_03.png" alt="오랜 임상 경험과 노하우를 통해 완성된 최적화 프로그램" usemap="pCode-689-03">
				</div>
			</div>
			<div class="sub-contents pCode-689-04">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_04.png" alt="주치의 &amp; 전담 관리사 &amp; 담당매니저의 집중 관리" usemap="pCode-689-04">
				</div>
			</div>
			<div class="sub-contents pCode-689-05">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_05.png" alt="" usemap="pCode-689-05">
				</div>
			</div>
			<div class="sub-contents pCode-689-06">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_06.png" alt="" usemap="pCode-689-06">
				</div>
			</div>
			<div class="sub-contents pCode-689-07">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_07.png" alt="" usemap="pCode-689-07">
				</div>
			</div>
			<div class="sub-contents pCode-689-08">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_08.png" alt="" usemap="pCode-689-08">
				</div>
			</div>
			<div class="sub-contents pCode-689-09">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_09.png" alt="" usemap="pCode-689-09">
				</div>
			</div>
			<div class="sub-contents pCode-689-10">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_10.png" alt="" usemap="pCode-689-10">
				</div>
			</div>
			<div class="sub-contents pCode-689-11">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_11.png" alt="" usemap="pCode-689-11">
				</div>
			</div>
			<div class="sub-contents pCode-689-12">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_12.png" alt="" usemap="pCode-689-12">
				</div>
			</div>
			<div class="sub-contents pCode-689-13">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_13.png" alt="" usemap="pCode-689-13">
				</div>
			</div>
			<div class="sub-contents pCode-689-14">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_14.png" alt="" usemap="pCode-689-14">
				</div>
			</div>
			<div class="sub-contents pCode-689-15">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_15.png" alt="" usemap="pCode-689-15">
				</div>
			</div>
			<div class="sub-contents pCode-689-16">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/689_img_16.png" alt="" usemap="pCode-689-16">
				</div>
			</div>
