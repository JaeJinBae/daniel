...
<body>
	...
	<div id="wrap">
		...
		<!--  닫기 [위치 : include_web_footer.html ]  -->
				...
				<div class="full">
					<ul>
						...
						<li class="gnb">
							...
							<ul>
								<li><a href="${pageContext.request.contextPath}/m/menu01_01">다니엘의 특별함</a></li>
								<li><a href="${pageContext.request.contextPath}/m/menu01_02">의료진 소개</a></li>
								<li><a href="${pageContext.request.contextPath}/m/menu01_03">진료시간/오시는길</a></li>
								<li><a href="${pageContext.request.contextPath}/m/menu01_04">보유장비</a></li>
								<li><a href="${pageContext.request.contextPath}/m/menu01_05">선한이웃, 다니엘</a></li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div id="sub-visual" data-sec="다니엘 소개" data-menu="의료진 소개">
				<div class="inner">
			...
			-->
			<div class="sub-contents pCode-500-01">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/500_img_01.png" alt="성형외과 &amp; 피부과 협진으로 최소 시술 최대 효과" usemap="pCode-500-01">
				</div>
			</div>
			<div class="sub-contents pCode-500-02">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/500_img_02.png" alt="프리미엄 오리지널 명품 레이저 보유" usemap="pCode-500-02">
				</div>
			</div>
			<div class="sub-contents pCode-500-03">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/500_img_03.png" alt="오랜 임상 경험과 노하우를 통해 완성된 최적화 프로그램" usemap="pCode-500-03">
				</div>
			</div>
			<div class="sub-contents pCode-500-04">
				<div class="full">
					<img src="${pageContext.request.contextPath}/resources/img/m/contents/500_img_04.png" alt="주치의 &amp; 전담 관리사 &amp; 담당매니저의 집중 관리" usemap="pCode-500-04">
				</div>
			</div>
