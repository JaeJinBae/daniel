				...
				<ul>
					...
					<li class="gnb ">
						...
						<ul class="lnb-wrap">
							...
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu03_06" data-text="성형 VIP 프로그램"><span>성형 VIP 프로그램</span></a></li>
						</ul>
					</li>
					<li class="gnb ">
						<button data-text="레이저 클리닉"><span>레이저 클리닉</span></button>
						<ul class="lnb-wrap">
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_01" data-text="다니엘 복합레이저"><span>다니엘 복합레이저</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_02" data-text="난치성색소"><span>난치성색소</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_03" data-text="여드름"><span>여드름</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_04" data-text="안면홍조"><span>안면홍조</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_05" data-text="모공/흉터"><span>모공/흉터</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_06" data-text="프리미엄토닝"><span>프리미엄토닝</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_07" data-text="웨딩패키지"><span>웨딩패키지</span></a></li>
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu04_08" data-text="흉터 클리닉"><span>흉터 클리닉</span></a></li>
						</ul>
					</li>
					<li class="gnb ">
					...
					<li class="gnb ">
						...
						<ul class="lnb-wrap">
							...
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu06_03" data-text="트임성형"><span>트임성형/복원술</span></a></li>
					...
					<li class="gnb ">
						...
						<ul class="lnb-wrap">
							...
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu07_06" data-text="여유증 교정"><span>여유증 교정</span></a></li>
						</ul>
					</li>
					<li class="gnb ">
						...
						<ul class="lnb-wrap">
							...
							<li class="lnb "><a href="${pageContext.request.contextPath}/m/menu08_04" data-text="필로가135주사"><span>다니엘스킨부스터</span></a></li>						
						</ul>
					</li>
					<li class="gnb ">
